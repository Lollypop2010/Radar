...
_G.RadarSettings = {
    ...
    --- Theme
    RADAR_THEME = {
        Outline = Color3.fromRGB(199,21,133); -- Radar outline
        Background = Color3.fromRGB(199,21,133); -- Radar background
        DragHandle = Color3.fromRGB(199,21,133); -- Drag handle 
 
        Cardinal_Lines = Color3.fromRGB(0,0,255); -- Color of the horizontal and vertical lines
        Distance_Lines = Color3.fromRGB(0,0,255); -- Color of the distance rings
 
        Generic_Marker = Color3.fromRGB(0,0,255); -- Color of a player marker without a team
        Local_Marker = Color3.fromRGB(0,0,255); -- Color of your marker, regardless of team
        Team_Marker = Color3.fromRGB(0,0,255); -- Color of your teammates markers. Used when DISPLAY_TEAM_COLORS is disabled
        Friend_Marker = Color3.fromRGB(0,0,255); -- Color of your friends markers. Used when DISPLAY_FRIEND_COLORS is enabled 
    };
}
